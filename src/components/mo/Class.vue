        ...
        <v-dialog transition="dialog-top-transition" v-model="dialogTambah" persistent max-width="600px">
            <v-card>
                <v-form @submit.prevent="dialogAreUSureAdd = true">
                    ...
                    <v-card-text>
                        <v-container>
                            <v-text-field v-model="kelasTemp.name" label="nama kelas" clearable
                                :error-messages="validation.name"></v-text-field>
                            <v-text-field v-model="kelasTemp.price" label="harga kelas" clearable
        ...
        <v-dialog transition="dialog-top-transition" v-model="dialogEdit" persistent max-width="600px">
            <v-card>
                <v-form @submit.prevent="dialogAreUSureEdit = true">
                    ...
                    <v-card-text>
                        <v-container>
                            <v-text-field v-model="editedItem.name" label="nama kelas" clearable
                                :error-messages="validation.name"></v-text-field>
                            <v-text-field v-model="editedItem.price" label="harga kelas" clearable
                                :error-messages="validation.price"></v-text-field>
                        </v-container>
                    </v-card-text>
                    <v-card-actions>
