<template>
    <v-main class="list">
        ...
        <v-card>
            <v-data-table :headers="headers" :items="kinerjaInstruktur" :search="search">
            </v-data-table>
        </v-card>
...
export default {
    data() {
        return {
            ...
            headers: [
                ...
                { text: "Waktu Terlambat (detik)", value: "waktu_terlambat" },
            ],
    ...
    methods: {
        ...
        getData(bulan, tahun) {
            axios.get(Api.BASE_URL + `/kinerjaInstrukturPerTahun/${bulan}/${tahun}`, {
                headers: {
                    'Accept': 'application/json',
                    'Authorization': 'Bearer ' + $cookies.get("SESSION")
                }
            }).then((response) => {
                this.kinerjaInstruktur = response.data.data;
        ...
        getBulanTahun() {
            axios.get(Api.BASE_URL + "/howManyMonthYearInKinerjaInstruktur", {
                headers: {
                    'Accept': 'application/json',
                    'Authorization': 'Bearer ' + $cookies.get("SESSION")
                }
        ...
        cetakPDF(bulan, tahun) {
            if (tahun == null || bulan == null) {
                ...
                axios.get(Api.BASE_URL + `/kinerjaInstrukturPerTahunPDF/${bulan}/${tahun}`, {
                    responseType: 'blob',
                    headers: {
                        'Accept': 'application/json',
                        'Authorization': 'Bearer ' + $cookies.get("SESSION")
                    ...
                    fileLink.setAttribute('download', `kinerjaInstruktur Bulan ${bulan} - ${tahun}.pdf`);
